function [I, J, K, vals] = get_user_ROI_v2(dirname)
...
cd(codedir);
if nargin < 1
    dirname = 'C:\Documents and Settings\amk2012\Desktop\NPH28\download20100304155511\49150632\01190990';
end
thresh_ratio = 0.06;
