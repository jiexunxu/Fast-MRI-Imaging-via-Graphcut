...
%         >> hdr = read_gehdr(id);
%
%  note:  Raw file must have RDB_RDBM_REVISION = 9.00
...
hdr.rdb.int_raw_pass_size = fread(id, 1, 'ulong');  % rhrawsize 0 - 2147483647
hdr.rdb.int_sspsave = fread(id, 1, 'ulong');  % rhsspsave 0 - 2147483647
hdr.rdb.int_udasave = fread(id, 1, 'ulong');  % rhudasave 0 - 2147483647
...
hdr.rdb.a3dscale = fread(id, 1, 'float');  % Use to scale 3D acqs to avoid overrange 
...
hdr.exam.double_padding = fread(id, 9, 'double');  % Please use this if you are adding any doubles
...
hdr.exam.float_padding = fread(id, 8, 'float');  % Please use this if you are adding any floats
...
hdr.exam.long_padding = fread(id, 8, 'long');  % Please use this if you are adding any longs
...
hdr.exam.int_padding = fread(id, 12, 'int');  % Please use this if you are adding any ints
...
hdr.exam.short_padding = fread(id, 11, 'short');  % Please use this if you are adding any shorts
...
hdr.exam.ex_padding = fread(id, 62, '*char')';  % Spare Space only for BLOCKs
hdr.series.double_padding = fread(id, 7, 'double');  % Please use this if you are adding any doubles
...
hdr.series.float_padding = fread(id, 8, 'float');  % Please use this if you are adding any floats
...
hdr.series.long_padding = fread(id, 8, 'long');  % Please use this if you are adding any longs
...
hdr.series.int_padding = fread(id, 16, 'int');  % Please use this if you are adding any ints
...
hdr.series.short_padding = fread(id, 26, 'short');  % Please use this if you are adding any shots
...
hdr.series.operator_new = fread(id, 65, '*char')';  
hdr.series.se_padding = fread(id, 150, '*char')';  % Spare Space
hdr.image.double_padding = fread(id, 8, 'double');  % Please use this if you are adding any doubles
...
hdr.image.float_padding = fread(id, 32, 'float');  % Please use this if you are adding any floats
...
hdr.image.long_padding = fread(id, 8, 'long');  % Please use this if you are adding any longs
...
hdr.image.short_padding = fread(id, 32, 'short');  % Please use this if you are adding any shorts
...
hdr.image.img_hdr_padding = fread(id, 210, '*char')';  
