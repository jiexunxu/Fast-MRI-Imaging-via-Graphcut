...
function [t, outpos] = gehdr_reader14M5(chr, inpos, type, count)
...
function [t, outpos] = read_PRESCAN_HEADER(chr, inpos, count)
  ...
  t.buffer = read_s8(chr2(1425:1500,:), 1, count*76);
...
function [t, outpos] = read_OP_PS_SKIP_TYPE(chr, inpos, count)
  outpos = inpos + 316 * count;
  chr2=reshape(chr(inpos:inpos+count*316-1), 316, []);
...
function [t, outpos] = read_OP_PS_SKIP_PACK_TYPE(chr, inpos, count)
  outpos = inpos + 356 * count;
  chr2=reshape(chr(inpos:inpos+count*356-1), 356, []);
  t.hdr = read_OP_HDR_TYPE(chr2(1:40,:), 1, count);
  t.req = read_OP_PS_SKIP_TYPE(chr2(41:356,:), 1, count);
...
function [t, outpos] = read_SERIESDATATYPE(chr, inpos, count)
  ...
  t.short_padding = read_short_int(chr2(433:484,:), 1, count*26);
...
function [t, outpos] = read_MRIMAGEDATATYPE(chr, inpos, count)
  ...
  t.int_padding = read_int(chr2(893:1020,:), 1, count*32);
  ...
  t.im_no = read_short_int(chr2(1039:1040,:), 1, count);
  t.contmode = read_short_int(chr2(1041:1042,:), 1, count);
  t.serrx = read_short_int(chr2(1043:1044,:), 1, count);
  t.imgrx = read_short_int(chr2(1045:1046,:), 1, count);
  t.screenformat = read_short_int(chr2(1047:1048,:), 1, count);
  t.plane = read_short_int(chr2(1049:1050,:), 1, count);
  t.im_compress = read_short_int(chr2(1051:1052,:), 1, count);
  t.im_scouttype = read_short_int(chr2(1053:1054,:), 1, count);
  t.contig = read_short_int(chr2(1055:1056,:), 1, count);
  t.hrtrate = read_short_int(chr2(1057:1058,:), 1, count);
  t.trgwindow = read_short_int(chr2(1059:1060,:), 1, count);
  t.imgpcyc = read_short_int(chr2(1061:1062,:), 1, count);
  t.obsolete3 = read_short_int(chr2(1063:1064,:), 1, count);
  t.obsolete4 = read_short_int(chr2(1065:1066,:), 1, count);
  t.obsolete5 = read_short_int(chr2(1067:1068,:), 1, count);
  t.mr_flip = read_short_int(chr2(1069:1070,:), 1, count);
  t.cphase = read_short_int(chr2(1071:1072,:), 1, count);
  t.swappf = read_short_int(chr2(1073:1074,:), 1, count);
  t.pauseint = read_short_int(chr2(1075:1076,:), 1, count);
  t.obsolete6 = read_short_int(chr2(1077:1078,:), 1, count);
  t.obsolete7 = read_short_int(chr2(1079:1080,:), 1, count);
  t.obsolete8 = read_short_int(chr2(1081:1082,:), 1, count);
  t.not_used_1 = read_short_int(chr2(1083:1084,:), 1, count);
  t.imode = read_short_int(chr2(1085:1086,:), 1, count);
  t.pseq = read_short_int(chr2(1087:1088,:), 1, count);
  t.pseqmode = read_short_int(chr2(1089:1090,:), 1, count);
  t.unused_monsar = read_short_int(chr2(1091:1092,:), 1, count);
  t.ctyp = read_short_int(chr2(1093:1094,:), 1, count);
  t.surfctyp = read_short_int(chr2(1095:1096,:), 1, count);
  t.surfcext = read_short_int(chr2(1097:1098,:), 1, count);
  t.supp_tech = read_short_int(chr2(1099:1100,:), 1, count);
  t.slquant = read_short_int(chr2(1101:1102,:), 1, count);
  t.gpre = read_short_int(chr2(1103:1104,:), 1, count);
  t.satbits = read_short_int(chr2(1105:1106,:), 1, count);
  t.scic = read_short_int(chr2(1107:1108,:), 1, count);
  t.satxloc1 = read_short_int(chr2(1109:1110,:), 1, count);
  t.satxloc2 = read_short_int(chr2(1111:1112,:), 1, count);
  t.satyloc1 = read_short_int(chr2(1113:1114,:), 1, count);
  t.satyloc2 = read_short_int(chr2(1115:1116,:), 1, count);
  t.satzloc1 = read_short_int(chr2(1117:1118,:), 1, count);
  t.satzloc2 = read_short_int(chr2(1119:1120,:), 1, count);
  t.satxthick = read_short_int(chr2(1121:1122,:), 1, count);
  t.satythick = read_short_int(chr2(1123:1124,:), 1, count);
  t.satzthick = read_short_int(chr2(1125:1126,:), 1, count);
  t.flax = read_short_int(chr2(1127:1128,:), 1, count);
  t.venc = read_short_int(chr2(1129:1130,:), 1, count);
  t.thk_disclmr = read_short_int(chr2(1131:1132,:), 1, count);
  t.obsolete9 = read_short_int(chr2(1133:1134,:), 1, count);
  t.obsolete10 = read_short_int(chr2(1135:1136,:), 1, count);
  t.image_type = read_short_int(chr2(1137:1138,:), 1, count);
  t.vas_collapse = read_short_int(chr2(1139:1140,:), 1, count);
  t.proj_alg = read_short_int(chr2(1141:1142,:), 1, count);
  t.echo_trn_len = read_short_int(chr2(1143:1144,:), 1, count);
  t.frac_echo = read_short_int(chr2(1145:1146,:), 1, count);
  t.prep_pulse = read_short_int(chr2(1147:1148,:), 1, count);
  t.cphasenum = read_short_int(chr2(1149:1150,:), 1, count);
  t.var_echo = read_short_int(chr2(1151:1152,:), 1, count);
  t.scanactno = read_short_int(chr2(1153:1154,:), 1, count);
  t.vasflags = read_short_int(chr2(1155:1156,:), 1, count);
  t.integrity = read_short_int(chr2(1157:1158,:), 1, count);
  t.freq_dir = read_short_int(chr2(1159:1160,:), 1, count);
  t.vas_mode = read_short_int(chr2(1161:1162,:), 1, count);
  t.hole = read_short_int(chr2(1163:1164,:), 1, count);
  t.pscopts = read_short_int(chr2(1165:1166,:), 1, count);
  t.obsolete11 = read_short_int(chr2(1167:1168,:), 1, count);
  t.obsolete12 = read_short_int(chr2(1169:1170,:), 1, count);
  t.obsolete13 = read_short_int(chr2(1171:1172,:), 1, count);
  t.unoriginal = read_short_int(chr2(1173:1174,:), 1, count);
  t.interleaves = read_short_int(chr2(1175:1176,:), 1, count);
  t.effechospace = read_short_int(chr2(1177:1178,:), 1, count);
  t.viewsperseg = read_short_int(chr2(1179:1180,:), 1, count);
  t.rbpm = read_short_int(chr2(1181:1182,:), 1, count);
  t.rtpoint = read_short_int(chr2(1183:1184,:), 1, count);
  t.rcvrtype = read_short_int(chr2(1185:1186,:), 1, count);
  t.sarMode = read_short_int(chr2(1187:1188,:), 1, count);
  t.dBdtMode = read_short_int(chr2(1189:1190,:), 1, count);
  t.govBody = read_short_int(chr2(1191:1192,:), 1, count);
  t.sarDefinition = read_short_int(chr2(1193:1194,:), 1, count);
  t.no_shimvol = read_short_int(chr2(1195:1196,:), 1, count);
  t.shim_vol_type = read_short_int(chr2(1197:1198,:), 1, count);
  t.current_phase = read_short_int(chr2(1199:1200,:), 1, count);
  t.art_level = read_short_int(chr2(1201:1202,:), 1, count);
  t.slice_group_number = read_short_int(chr2(1203:1204,:), 1, count);
  t.number_of_slice_groups = read_short_int(chr2(1205:1206,:), 1, count);
  t.show_in_autoview = read_short_int(chr2(1207:1208,:), 1, count);
  t.short_padding = read_short_int(chr2(1209:1272,:), 1, count*32);
...
function [t, outpos] = read_struct_DbKeyNamer(chr, inpos, count)
  ...
  t.im_no = read_dbkey_image_type(chr2(11:12,:), 1, count);
...
function [t, outpos] = read_RDB_HEADER_REC(chr, inpos, count)
  ...
  t.rdb_hdr_nslices = read_short(chr2(69:70,:), 1, count);
  ...
  t.rdb_hdr_excess = read_short(chr2(1617:2048,:), 1, count*216);
