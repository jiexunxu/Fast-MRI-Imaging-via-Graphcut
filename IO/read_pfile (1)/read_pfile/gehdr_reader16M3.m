...
function [t, outpos] = gehdr_reader16M3(chr, inpos, type, count)
...
function [t, outpos] = read_OP_APS_START_TYPE(chr, inpos, count)
  outpos = inpos + 816 * count;
  chr2=reshape(chr(inpos:inpos+count*816-1), 816, []);
  t.req_opcode = read_s32(chr2(1:4,:), 1, count);
  t.pass_desc = read_s32(chr2(5:8,:), 1, count);
  t.req_size = read_s32(chr2(9:12,:), 1, count);
  ...
  t.fseps_mode = read_s32(chr2(429:432,:), 1, count);
  t.fseps_b0only_last_iter = read_s32(chr2(433:436,:), 1, count);
  t.fseps_slices = read_s32(chr2(437:440,:), 1, count);
  t.fseps_xres = read_s32(chr2(441:444,:), 1, count);
  t.fseps2_iter = read_s32(chr2(445:448,:), 1, count);
  t.fseps2_zffactor = read_f32(chr2(449:452,:), 1, count);
  t.isZ2 = read_s32(chr2(453:456,:), 1, count);
  t.isZ2autoshim = read_s32(chr2(457:460,:), 1, count);
  t.ps_connected_coil = read_s32(chr2(461:464,:), 1, count);
  t.apa_coilsel = read_s32(chr2(465:468,:), 1, count);
  t.apa_fov = read_f32(chr2(469:472,:), 1, count);
  t.apa_coilname = read_s8(chr2(473:492,:), 1, count*20);
  t.num_psc_vol = read_s32(chr2(493:496,:), 1, count);
  t.num_psc_slab = read_s32(chr2(497:500,:), 1, count);
  t.num_psc_rcvn_slab = read_s32(chr2(501:504,:), 1, count);
  t.cur_pos_vol2x = read_s32(chr2(505:508,:), 1, count);
  t.cur_pos_vol2y = read_s32(chr2(509:512,:), 1, count);
  t.cur_pos_vol2z = read_s32(chr2(513:516,:), 1, count);
  t.cur_ax_vol2x = read_s32(chr2(517:520,:), 1, count);
  t.cur_ax_vol2y = read_s32(chr2(521:524,:), 1, count);
  t.cur_ax_vol2z = read_s32(chr2(525:528,:), 1, count);
  t.ir_flag = read_s32(chr2(529:532,:), 1, count);
  t.escfh_slices = read_s32(chr2(533:536,:), 1, count);
  t.coil_weight = read_f32(chr2(537:664,:), 1, count*32);
  t.fseps_rcvr = read_s32(chr2(665:668,:), 1, count);
  t.runReceiverNoise = read_s32(chr2(669:672,:), 1, count);
  t.receiverNoiseStdDev = read_f32(chr2(673:800,:), 1, count*32);
  t.max_rg = read_s32(chr2(801:804,:), 1, count);
  t.psc_prep = read_s32(chr2(805:808,:), 1, count);
  t.cfh_raise_threshold = read_s32(chr2(809:812,:), 1, count);
  t.indicate_single_peak = read_s32(chr2(813:816,:), 1, count);

function [t, outpos] = read_OP_APS_START_PACK_TYPE(chr, inpos, count)
  outpos = inpos + 856 * count;
  chr2=reshape(chr(inpos:inpos+count*856-1), 856, []);
  t.hdr = read_OP_HDR_TYPE(chr2(1:40,:), 1, count);
  t.req = read_OP_APS_START_TYPE(chr2(41:856,:), 1, count);
...
function [t, outpos] = read_MRIMAGEDATATYPE(chr, inpos, count)
  ...
  t.double_padding = read_double(chr2(49:112,:), 1, count*8);
  t.dfov = read_float(chr2(113:116,:), 1, count);
  t.dfov_rect = read_float(chr2(117:120,:), 1, count);
  t.sctime = read_float(chr2(121:124,:), 1, count);
  t.slthick = read_float(chr2(125:128,:), 1, count);
  t.scanspacing = read_float(chr2(129:132,:), 1, count);
  t.loc = read_float(chr2(133:136,:), 1, count);
  t.tbldlta = read_float(chr2(137:140,:), 1, count);
  t.nex = read_float(chr2(141:144,:), 1, count);
  t.reptime = read_float(chr2(145:148,:), 1, count);
  t.saravg = read_float(chr2(149:152,:), 1, count);
  t.sarpeak = read_float(chr2(153:156,:), 1, count);
  t.pausetime = read_float(chr2(157:160,:), 1, count);
  t.vbw = read_float(chr2(161:164,:), 1, count);
  t.user0 = read_float(chr2(165:168,:), 1, count);
  t.user1 = read_float(chr2(169:172,:), 1, count);
  t.user2 = read_float(chr2(173:176,:), 1, count);
  t.user3 = read_float(chr2(177:180,:), 1, count);
  t.user4 = read_float(chr2(181:184,:), 1, count);
  t.user5 = read_float(chr2(185:188,:), 1, count);
  t.user6 = read_float(chr2(189:192,:), 1, count);
  t.user7 = read_float(chr2(193:196,:), 1, count);
  t.user8 = read_float(chr2(197:200,:), 1, count);
  t.user9 = read_float(chr2(201:204,:), 1, count);
  t.user10 = read_float(chr2(205:208,:), 1, count);
  t.user11 = read_float(chr2(209:212,:), 1, count);
  t.user12 = read_float(chr2(213:216,:), 1, count);
  t.user13 = read_float(chr2(217:220,:), 1, count);
  t.user14 = read_float(chr2(221:224,:), 1, count);
  t.user15 = read_float(chr2(225:228,:), 1, count);
  t.user16 = read_float(chr2(229:232,:), 1, count);
  t.user17 = read_float(chr2(233:236,:), 1, count);
  t.user18 = read_float(chr2(237:240,:), 1, count);
  t.user19 = read_float(chr2(241:244,:), 1, count);
  t.user20 = read_float(chr2(245:248,:), 1, count);
  t.user21 = read_float(chr2(249:252,:), 1, count);
  t.user22 = read_float(chr2(253:256,:), 1, count);
  t.proj_ang = read_float(chr2(257:260,:), 1, count);
  t.concat_sat = read_float(chr2(261:264,:), 1, count);
  t.user23 = read_float(chr2(265:268,:), 1, count);
  t.user24 = read_float(chr2(269:272,:), 1, count);
  t.x_axis_rot = read_float(chr2(273:276,:), 1, count);
  t.y_axis_rot = read_float(chr2(277:280,:), 1, count);
  t.z_axis_rot = read_float(chr2(281:284,:), 1, count);
  t.ihtagfa = read_float(chr2(285:288,:), 1, count);
  t.ihtagor = read_float(chr2(289:292,:), 1, count);
  t.ihbspti = read_float(chr2(293:296,:), 1, count);
  t.rtia_timer = read_float(chr2(297:300,:), 1, count);
  t.fps = read_float(chr2(301:304,:), 1, count);
  t.vencscale = read_float(chr2(305:308,:), 1, count);
  t.dbdt = read_float(chr2(309:312,:), 1, count);
  t.dbdtper = read_float(chr2(313:316,:), 1, count);
  t.estdbdtper = read_float(chr2(317:320,:), 1, count);
  t.estdbdtts = read_float(chr2(321:324,:), 1, count);
  t.saravghead = read_float(chr2(325:328,:), 1, count);
  t.neg_scanspacing = read_float(chr2(329:332,:), 1, count);
  t.user25 = read_float(chr2(333:336,:), 1, count);
  t.user26 = read_float(chr2(337:340,:), 1, count);
  t.user27 = read_float(chr2(341:344,:), 1, count);
  t.user28 = read_float(chr2(345:348,:), 1, count);
  t.user29 = read_float(chr2(349:352,:), 1, count);
  t.user30 = read_float(chr2(353:356,:), 1, count);
  t.user31 = read_float(chr2(357:360,:), 1, count);
  t.user32 = read_float(chr2(361:364,:), 1, count);
  t.user33 = read_float(chr2(365:368,:), 1, count);
  t.user34 = read_float(chr2(369:372,:), 1, count);
  t.user35 = read_float(chr2(373:376,:), 1, count);
  t.user36 = read_float(chr2(377:380,:), 1, count);
  t.user37 = read_float(chr2(381:384,:), 1, count);
  t.user38 = read_float(chr2(385:388,:), 1, count);
  t.user39 = read_float(chr2(389:392,:), 1, count);
  t.user40 = read_float(chr2(393:396,:), 1, count);
  t.user41 = read_float(chr2(397:400,:), 1, count);
  t.user42 = read_float(chr2(401:404,:), 1, count);
  t.user43 = read_float(chr2(405:408,:), 1, count);
  t.user44 = read_float(chr2(409:412,:), 1, count);
  t.user45 = read_float(chr2(413:416,:), 1, count);
  t.user46 = read_float(chr2(417:420,:), 1, count);
  t.user47 = read_float(chr2(421:424,:), 1, count);
  t.user48 = read_float(chr2(425:428,:), 1, count);
  t.RegressorVal = read_float(chr2(429:432,:), 1, count);
  t.SliceAsset = read_float(chr2(433:436,:), 1, count);
  t.PhaseAsset = read_float(chr2(437:440,:), 1, count);
  t.sarValues = read_float(chr2(441:456,:), 1, count*4);
  t.shim_fov = read_float(chr2(457:464,:), 1, count*2);
  t.shim_ctr_R = read_float(chr2(465:472,:), 1, count*2);
  t.shim_ctr_A = read_float(chr2(473:480,:), 1, count*2);
  t.shim_ctr_S = read_float(chr2(481:488,:), 1, count*2);
  t.dim_X = read_float(chr2(489:492,:), 1, count);
  t.dim_Y = read_float(chr2(493:496,:), 1, count);
  t.pixsize_X = read_float(chr2(497:500,:), 1, count);
  t.pixsize_Y = read_float(chr2(501:504,:), 1, count);
  t.ctr_R = read_float(chr2(505:508,:), 1, count);
  t.ctr_A = read_float(chr2(509:512,:), 1, count);
  t.ctr_S = read_float(chr2(513:516,:), 1, count);
  t.norm_R = read_float(chr2(517:520,:), 1, count);
  t.norm_A = read_float(chr2(521:524,:), 1, count);
  t.norm_S = read_float(chr2(525:528,:), 1, count);
  t.tlhc_R = read_float(chr2(529:532,:), 1, count);
  t.tlhc_A = read_float(chr2(533:536,:), 1, count);
  t.tlhc_S = read_float(chr2(537:540,:), 1, count);
  t.trhc_R = read_float(chr2(541:544,:), 1, count);
  t.trhc_A = read_float(chr2(545:548,:), 1, count);
  t.trhc_S = read_float(chr2(549:552,:), 1, count);
  t.brhc_R = read_float(chr2(553:556,:), 1, count);
  t.brhc_A = read_float(chr2(557:560,:), 1, count);
  t.brhc_S = read_float(chr2(561:564,:), 1, count);
  t.float_padding = read_float(chr2(565:692,:), 1, count*32);
  t.cal_fldstr = read_unsigned_long(chr2(693:696,:), 1, count);
  t.im_checksum = read_unsigned_long(chr2(697:700,:), 1, count);
  t.user_usage_tag = read_unsigned_long(chr2(701:704,:), 1, count);
  t.user_fill_mapMSW = read_unsigned_long(chr2(705:708,:), 1, count);
  t.user_fill_mapLSW = read_unsigned_long(chr2(709:712,:), 1, count);
  t.im_archived = read_long(chr2(713:716,:), 1, count);
  t.im_complete = read_long(chr2(717:720,:), 1, count);
  t.long_padding = read_long(chr2(721:752,:), 1, count*8);
  t.im_datetime = read_int(chr2(753:756,:), 1, count);
  t.im_actual_dt = read_int(chr2(757:760,:), 1, count);
  t.tr = read_int(chr2(761:764,:), 1, count);
  t.ti = read_int(chr2(765:768,:), 1, count);
  t.te = read_int(chr2(769:772,:), 1, count);
  t.te2 = read_int(chr2(773:776,:), 1, count);
  t.tdel = read_int(chr2(777:780,:), 1, count);
  t.mindat = read_int(chr2(781:784,:), 1, count);
  t.obplane = read_int(chr2(785:788,:), 1, count);
  t.slocfov = read_int(chr2(789:792,:), 1, count);
  t.obsolete1 = read_int(chr2(793:796,:), 1, count);
  t.obsolete2 = read_int(chr2(797:800,:), 1, count);
  t.user_bitmap = read_int(chr2(801:804,:), 1, count);
  t.iopt = read_int(chr2(805:808,:), 1, count);
  t.psd_datetime = read_int(chr2(809:812,:), 1, count);
  t.rawrunnum = read_int(chr2(813:816,:), 1, count);
  t.intr_del = read_int(chr2(817:820,:), 1, count);
  t.im_lastmod = read_int(chr2(821:824,:), 1, count);
  t.im_pds_a = read_int(chr2(825:828,:), 1, count);
  t.im_pds_c = read_int(chr2(829:832,:), 1, count);
  t.im_pds_u = read_int(chr2(833:836,:), 1, count);
  t.thresh_min1 = read_int(chr2(837:840,:), 1, count);
  t.thresh_max1 = read_int(chr2(841:844,:), 1, count);
  t.thresh_min2 = read_int(chr2(845:848,:), 1, count);
  t.thresh_max2 = read_int(chr2(849:852,:), 1, count);
  t.numslabs = read_int(chr2(853:856,:), 1, count);
  t.locsperslab = read_int(chr2(857:860,:), 1, count);
  t.overlaps = read_int(chr2(861:864,:), 1, count);
  t.slop_int_4 = read_int(chr2(865:868,:), 1, count);
  t.dfax = read_int(chr2(869:872,:), 1, count);
  t.fphase = read_int(chr2(873:876,:), 1, count);
  t.offsetfreq = read_int(chr2(877:880,:), 1, count);
  t.b_value = read_int(chr2(881:884,:), 1, count);
  t.iopt2 = read_int(chr2(885:888,:), 1, count);
  t.ihtagging = read_int(chr2(889:892,:), 1, count);
  t.ihtagspc = read_int(chr2(893:896,:), 1, count);
  t.ihfcineim = read_int(chr2(897:900,:), 1, count);
  t.ihfcinent = read_int(chr2(901:904,:), 1, count);
  t.num_seg = read_int(chr2(905:908,:), 1, count);
  t.oprtarr = read_int(chr2(909:912,:), 1, count);
  t.averages = read_int(chr2(913:916,:), 1, count);
  t.station_index = read_int(chr2(917:920,:), 1, count);
  t.station_total = read_int(chr2(921:924,:), 1, count);
  t.iopt3 = read_int(chr2(925:928,:), 1, count);
  t.delAcq = read_int(chr2(929:932,:), 1, count);
  t.rxmbloblen = read_int(chr2(933:936,:), 1, count);
  t.im_no = read_int(chr2(941:944,:), 1, count);
  t.imgrx = read_int(chr2(945:948,:), 1, count);
  t.int_padding = read_int(chr2(949:1068,:), 1, count*30);
  t.imatrix_X = read_short_int(chr2(1069:1070,:), 1, count);
  t.imatrix_Y = read_short_int(chr2(1071:1072,:), 1, count);
  t.im_exno = read_unsigned_short_int(chr2(1073:1074,:), 1, count);
  t.img_window = read_unsigned_short_int(chr2(1075:1076,:), 1, count);
  t.img_level = read_short_int(chr2(1077:1078,:), 1, count);
  t.numecho = read_short_int(chr2(1079:1080,:), 1, count);
  t.echonum = read_short_int(chr2(1081:1082,:), 1, count);
  t.im_uniq = read_short_int(chr2(1083:1084,:), 1, count);
  t.im_seno = read_short_int(chr2(1085:1086,:), 1, count);
  t.contmode = read_short_int(chr2(1087:1088,:), 1, count);
  t.serrx = read_short_int(chr2(1089:1090,:), 1, count);
  t.screenformat = read_short_int(chr2(1091:1092,:), 1, count);
  t.plane = read_short_int(chr2(1093:1094,:), 1, count);
  t.im_compress = read_short_int(chr2(1095:1096,:), 1, count);
  t.im_scouttype = read_short_int(chr2(1097:1098,:), 1, count);
  t.contig = read_short_int(chr2(1099:1100,:), 1, count);
  t.hrtrate = read_short_int(chr2(1101:1102,:), 1, count);
  t.trgwindow = read_short_int(chr2(1103:1104,:), 1, count);
  t.imgpcyc = read_short_int(chr2(1105:1106,:), 1, count);
  t.obsolete3 = read_short_int(chr2(1107:1108,:), 1, count);
  t.obsolete4 = read_short_int(chr2(1109:1110,:), 1, count);
  t.obsolete5 = read_short_int(chr2(1111:1112,:), 1, count);
  t.mr_flip = read_short_int(chr2(1113:1114,:), 1, count);
  t.cphase = read_short_int(chr2(1115:1116,:), 1, count);
  t.swappf = read_short_int(chr2(1117:1118,:), 1, count);
  t.pauseint = read_short_int(chr2(1119:1120,:), 1, count);
  t.obsolete6 = read_short_int(chr2(1121:1122,:), 1, count);
  t.obsolete7 = read_short_int(chr2(1123:1124,:), 1, count);
  t.obsolete8 = read_short_int(chr2(1125:1126,:), 1, count);
  t.not_used_1 = read_short_int(chr2(1127:1128,:), 1, count);
  t.imode = read_short_int(chr2(1129:1130,:), 1, count);
  t.pseq = read_short_int(chr2(1131:1132,:), 1, count);
  t.pseqmode = read_short_int(chr2(1133:1134,:), 1, count);
  t.fMRI100K = read_short_int(chr2(1135:1136,:), 1, count);
  t.ctyp = read_short_int(chr2(1137:1138,:), 1, count);
  t.surfctyp = read_short_int(chr2(1139:1140,:), 1, count);
  t.surfcext = read_short_int(chr2(1141:1142,:), 1, count);
  t.supp_tech = read_short_int(chr2(1143:1144,:), 1, count);
  t.slquant = read_short_int(chr2(1145:1146,:), 1, count);
  t.gpre = read_short_int(chr2(1147:1148,:), 1, count);
  t.satbits = read_short_int(chr2(1149:1150,:), 1, count);
  t.scic = read_short_int(chr2(1151:1152,:), 1, count);
  t.satxloc1 = read_short_int(chr2(1153:1154,:), 1, count);
  t.satxloc2 = read_short_int(chr2(1155:1156,:), 1, count);
  t.satyloc1 = read_short_int(chr2(1157:1158,:), 1, count);
  t.satyloc2 = read_short_int(chr2(1159:1160,:), 1, count);
  t.satzloc1 = read_short_int(chr2(1161:1162,:), 1, count);
  t.satzloc2 = read_short_int(chr2(1163:1164,:), 1, count);
  t.satxthick = read_short_int(chr2(1165:1166,:), 1, count);
  t.satythick = read_short_int(chr2(1167:1168,:), 1, count);
  t.satzthick = read_short_int(chr2(1169:1170,:), 1, count);
  t.flax = read_short_int(chr2(1171:1172,:), 1, count);
  t.venc = read_short_int(chr2(1173:1174,:), 1, count);
  t.thk_disclmr = read_short_int(chr2(1175:1176,:), 1, count);
  t.obsolete9 = read_short_int(chr2(1177:1178,:), 1, count);
  t.obsolete10 = read_short_int(chr2(1179:1180,:), 1, count);
  t.image_type = read_short_int(chr2(1181:1182,:), 1, count);
  t.vas_collapse = read_short_int(chr2(1183:1184,:), 1, count);
  t.proj_alg = read_short_int(chr2(1185:1186,:), 1, count);
  t.echo_trn_len = read_short_int(chr2(1187:1188,:), 1, count);
  t.frac_echo = read_short_int(chr2(1189:1190,:), 1, count);
  t.prep_pulse = read_short_int(chr2(1191:1192,:), 1, count);
  t.cphasenum = read_short_int(chr2(1193:1194,:), 1, count);
  t.var_echo = read_short_int(chr2(1195:1196,:), 1, count);
  t.scanactno = read_short_int(chr2(1197:1198,:), 1, count);
  t.vasflags = read_short_int(chr2(1199:1200,:), 1, count);
  t.integrity = read_short_int(chr2(1201:1202,:), 1, count);
  t.freq_dir = read_short_int(chr2(1203:1204,:), 1, count);
  t.vas_mode = read_short_int(chr2(1205:1206,:), 1, count);
  t.hole = read_short_int(chr2(1207:1208,:), 1, count);
  t.pscopts = read_short_int(chr2(1209:1210,:), 1, count);
  t.obsolete11 = read_short_int(chr2(1211:1212,:), 1, count);
  t.obsolete12 = read_short_int(chr2(1213:1214,:), 1, count);
  t.obsolete13 = read_short_int(chr2(1215:1216,:), 1, count);
  t.unoriginal = read_short_int(chr2(1217:1218,:), 1, count);
  t.interleaves = read_short_int(chr2(1219:1220,:), 1, count);
  t.effechospace = read_short_int(chr2(1221:1222,:), 1, count);
  t.viewsperseg = read_short_int(chr2(1223:1224,:), 1, count);
  t.rbpm = read_short_int(chr2(1225:1226,:), 1, count);
  t.rtpoint = read_short_int(chr2(1227:1228,:), 1, count);
  t.rcvrtype = read_short_int(chr2(1229:1230,:), 1, count);
  t.sarMode = read_short_int(chr2(1231:1232,:), 1, count);
  t.dBdtMode = read_short_int(chr2(1233:1234,:), 1, count);
  t.govBody = read_short_int(chr2(1235:1236,:), 1, count);
  t.sarDefinition = read_short_int(chr2(1237:1238,:), 1, count);
  t.no_shimvol = read_short_int(chr2(1239:1240,:), 1, count);
  t.shim_vol_type = read_short_int(chr2(1241:1242,:), 1, count);
  t.current_phase = read_short_int(chr2(1243:1244,:), 1, count);
  t.art_level = read_short_int(chr2(1245:1246,:), 1, count);
  t.slice_group_number = read_short_int(chr2(1247:1248,:), 1, count);
  t.number_of_slice_groups = read_short_int(chr2(1249:1250,:), 1, count);
  t.show_in_autoview = read_short_int(chr2(1251:1252,:), 1, count);
  t.slice_number_inGroup = read_short_int(chr2(1253:1254,:), 1, count);
  t.label_duration = read_unsigned_short_int(chr2(1255:1256,:), 1, count);
  t.scale_factor = read_short_int(chr2(1257:1258,:), 1, count);
  t.short_padding = read_short_int(chr2(1259:1320,:), 1, count*31);
  t.psdname = read_char(chr2(1321:1353,:), 1, count*33);
  t.proj_name = read_char(chr2(1354:1366,:), 1, count*13);
  t.psd_iname = read_char(chr2(1367:1379,:), 1, count*13);
  t.im_diskid = read_char(chr2(1380:1380,:), 1, count);
  t.pdid = read_char(chr2(1381:1394,:), 1, count*14);
  t.im_suid = read_char(chr2(1395:1398,:), 1, count*4);
  t.contrastIV = read_char(chr2(1399:1415,:), 1, count*17);
  t.contrastOral = read_char(chr2(1416:1432,:), 1, count*17);
  t.loc_ras = read_char(chr2(1433:1433,:), 1, count);
  t.forimgrev = read_char(chr2(1434:1437,:), 1, count*4);
  t.cname = read_char(chr2(1438:1454,:), 1, count*17);
  t.im_verscre = read_char(chr2(1455:1456,:), 1, count*2);
  t.im_verscur = read_char(chr2(1457:1458,:), 1, count*2);
  t.im_alloc_key = read_char(chr2(1459:1471,:), 1, count*13);
  t.ref_img = read_char(chr2(1472:1472,:), 1, count);
  t.sum_img = read_char(chr2(1473:1473,:), 1, count);
  t.filter_mode = read_char(chr2(1474:1489,:), 1, count*16);
  t.slop_str_2 = read_char(chr2(1490:1505,:), 1, count*16);
  t.image_uid = read_char(chr2(1506:1537,:), 1, count*32);
  t.sop_uid = read_char(chr2(1538:1569,:), 1, count*32);
  t.GEcname = read_char(chr2(1570:1593,:), 1, count*24);
  t.usedCoilData = read_char(chr2(1594:1693,:), 1, count*100);
  t.astcalseriesuid = read_char(chr2(1694:1725,:), 1, count*32);
  t.purecalseriesuid = read_char(chr2(1726:1757,:), 1, count*32);
  t.xml_psc_shm_vol = read_char(chr2(1758:1789,:), 1, count*32);
  t.rxmpath = read_char(chr2(1790:1853,:), 1, count*64);
  t.psdnameannot = read_char(chr2(1854:1886,:), 1, count*33);
  t.img_hdr_padding = read_char(chr2(1887:2048,:), 1, count*162);
...
function [t, outpos] = read_RDB_HEADER_REC(chr, inpos, count)
  ...
  t.rdb_hdr_numbvals = read_short(chr2(1683:1684,:), 1, count);
  t.rdb_hdr_numdifdirs = read_short(chr2(1685:1686,:), 1, count);
  t.rdb_hdr_difnext2 = read_short(chr2(1687:1688,:), 1, count);
  t.rdb_hdr_difnextab = read_short(chr2(1689:1888,:), 1, count*100);
  t.rdb_hdr_channel_combine_method = read_short(chr2(1889:1890,:), 1, count);
  t.rdb_hdr_nexForUnacquiredEncodes = read_short(chr2(1891:1892,:), 1, count);
  t.rdb_hdr_asl_perf_weighted_scale = read_short(chr2(1893:1894,:), 1, count);
  t.short_padding_1 = read_short(chr2(1895:1896,:), 1, count);
  t.rdb_hdr_excess = read_short(chr2(1897:2048,:), 1, count*76);
